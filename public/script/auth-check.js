(function () {
    ...
    const isOrderList = /\/order-list($|\/)/.test(path) || path.includes("order-list.html");
    ...
    const isPrivate = isProfile || isAddress || isAdminPanel || isProductAdd || isProductList || isCart || isSuccess || isrecentOrders || isOrderList;
