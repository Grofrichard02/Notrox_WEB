        ...
        if (cartItem && token) {
            cartBtnContainer.innerHTML = `
                <div class="details-qty-pill">
                    <button onclick="changeProductQty(${product.Id}, -1)"><i class="fa-solid fa-minus"></i></button>
                    <span class="details-qty-num">${cartItem.quantity}</span>
                    <button onclick="changeProductQty(${product.Id}, 1)"><i class="fa-solid fa-plus"></i></button>
                </div>
            `;
        } else {
            cartBtnContainer.innerHTML = `
